# Contributing to oxidized-types
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/types.git
cd types
...
`oxidized-types` is a library crate in the
...
Use `types` as the scope for all changes to this crate.
